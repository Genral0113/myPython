...
def get_waypoints():
    ...
    training_log = os.path.dirname(__file__) + r'\aws\training-simtrace\2019\waypoints-x'
    ...
    training_log = os.path.dirname(__file__) + r'\aws\training-simtrace\2019\waypoints-y'
...
if __name__ == '__main__':
    ...
    # for a, b in zip(x, y):
    #     i += 1
    #     plt.text(a, b, i, fontsize=5)
    # plt.show()

    waypoints_2019 = [[0.3236568570137024, 2.6803284883499146],
    ...
    x = []
    y = []
    for i in range(len(waypoints_2019)):
        x.append(waypoints_2019[i][0])
        y.append(waypoints_2019[i][1])

    plt.scatter(x, y, s=15, c='k')
    plt.title('waypoints-2019')
    i = 0
    for a, b in zip(x, y):
        i += 1
        plt.text(a, b, i, fontsize=8)
    plt.text(0.5, 6.2, '[135 - 17 ] - Daniel')
    plt.text(0.5, 6.0, '[ 18 - 56 ] - Ben')
    plt.text(0.5, 5.8, '[ 57 - 95 ] - Samuel')
    plt.text(0.5, 5.6, '[ 96 - 134] - June')
    plt.show()
