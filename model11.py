...
def maximum_reward():
    # negative exponential penalty
    max_reward = math.exp(0)
    # maximum of on_track_reward
    max_reward = 1e2
    # maximum of distance_from_center_reward
    max_reward *= 1.2
    # maximum of straight_line_reward
    max_reward *= 1.2
    # maximum of direction_reward
    max_reward *= 0.5
    # maximum of steering_reward
    max_reward += 0.8
    # maximum of throttle_reward
    max_reward *= 0.8
    return max_reward
