...
def calculate_distance_of_track_line(track_line):
    ...
    for i in range(len(track_line)):
        ...
        distance = distance_of_2points(prev_point, next_point)
...
def direction_2_points(prev_point, next_point):
    radians = math.atan2(next_point[1] - prev_point[1], next_point[0] - prev_point[0])
...
def generate_racing_track():
    ...
    track_line = multiple_track_line(waypoints)
